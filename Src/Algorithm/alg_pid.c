...
/**
  * @brief      初始化 PID 控制参数
  * @param      param: 指向 PID 控制参数的指针
  * @param      kp: 比例因子
  * @param      ki: 积分因子
  * @param      kd: 微分因子
  * @param      sum_max: 积分限幅
  * @param      output_max: 输出限幅
  * @param      kd_fil_frq: PID Kd 输出滤波参数
  * @param      delta_fil_frq: Delta PID 参考滤波参数
  * @param      kf_1: 一阶前馈参数
  * @param      kf_2: 二阶前馈参数
  * @param      kf1_fil_frq: 一阶前馈滤波参数
  * @param      kf2_fil_frq: 二阶前馈滤波参数
  * @param      period: PID 计算周期
  * @param      pid_mode: PID 计算模式
  * @retval     NULL  无返回值
  */
